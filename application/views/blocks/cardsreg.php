...
<h5 style="color:#4170b6; font-weight:300; size:18px; letter-spacing: 2px;">Рады приветствовать вас в проекте «Карта Добра»</h5>
...
<? if ($add) { ?>
        ...
        <div id="register" class="m">

            <div class="mheader">
                
                <h4>Зарегистрируйте Карту Добра если есть</h4>
            </div>
            <div class="mbody">
                ...
                <form action="addcard.php" method="POST" id="reg">
                    ...
                    <input id="cardreg" type="button" style="width:40%; float:left;"class="btn btn-large btn-block btn-info" value="Зарегистрировать"> <span style="margin-left:10px; font-size:16px;top:15px; postion:relative;">или <a href="/settings" style="">пропустить</a></span>
                </form>
...
<? if ($add) { ?>
             $('#cardreg').click(function(){
                 var bb = $(this).parents('.m'), p = bb.find('.mbody');
