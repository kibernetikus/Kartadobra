...
<ul class="nav nav-tabs" style="margin-top:-20px;">
  <li class="active"><a href="#addtask" data-toggle="tab" id="addtsk">Добавить просьбу</a></li>
    <li ><a href="#user_tasks" data-toggle="tab">Ваши предложения</a></li>
...
<div id="myTabContent" class="tab-content">
  <div  class="tab-pane fade in active" id="addtask" style="width:720px;  margin-top:0px;">
       ...
       <h4>Добавление предложения</h4><hr>

        <form class="form-horizontal" action="" id="task-form" data-content="#messages"  method="POST">
<div class="control-group">
<legend class="control-label">Заголовок предложения</legend>
<div class="controls">
            <input type="text" id="title" autofocus="autofocus" placeholder="Введите заголовок задания" maxlength="50" style="width:360px;" data-toggle="tooltip" title="Опишите кратко суть предложения" data-placement="right"><br><small>например: <span style="color:#3e6dab">Потерялась собака в районе парка Горького</span></small><br><br>
 </div>
</div>
...
<div class="control-group">
<legend class="control-label">Описание предложения</legend>
   <div class="controls">
            <textarea style="width:360px; height:90px;"  id="text" placeholder="Опишите суть предложения"></textarea> <br>
...
<legend>Укажите место на карте, если требуется</legend>
 ...
 <div id="map_canvas" style="margin: 0; padding: 0;  width:500px; height:400px;margin-bottom:20px;" class=""></div>
    ...
    <div id="user_tasks" style="width:720px;" class="tab-pane fade">
     ...
     <?if($offers0->count()==0){?><p>У вас нет актуальных предложений</p><?}?>
                <? foreach ($offers0 AS $v) { ?> 
...
<div class="media">
  ...
  <div class="media-body">
    <h4 class="media-heading"><a class="h" href="/offers/<?=$v->id?>"><?= $v->title ?></a></h4>
...
Просьба актуальна до 20.03.2013
  ...
  <? } ?>
    ...
    <div  class="tab-pane fade" id="donetask" style="width:720px;">
     <?if($offers1->count()==0){?><li>У вас нет выполненных предложений</li><?}?>
                <?foreach($offers1 AS $v){?>
<div class="media">
         <hr>
  <a class="pull-left h" href="/offers/<?=$v->id?>">
      <img src="/media/f/small/<?= media::get($v->medias->find()) ?>" class="img-polaroid" width="65px" >
  </a>
  <div class="media-body">
    <h4 class="media-heading"><a class="h" href="/offers/<?=$v->id?>"><?= $v->title ?></a></h4>
