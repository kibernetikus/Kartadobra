...
<div id="reg">
 ...
 <div class="control-group">
      ...
      <div class="controls">
       <select id="type">
                      <option value="1">Помощь медицине</option>
                      <option value="2">Помощь детям</option>
                      <option value="3">Помощь ветеранам</option>
                      <option value="4">Помощь инвалидам и пожилым</option>
                      <option value="5">Помощь животным</option>
                      <option value="6">Помощь природе</option>
                      <option value="7">Благотворительный фонд</option>
                      <option value="8">Помощь городу</option>
                  </select>
...
<script>
      $('#goreg').click(function(){
          ...
          j.g({g:'public/registration',p:'username='+f_login+'&password='+f_password+'&c='+f_city_id+'&n='+f_name+'&e='+f_email+'&t='+f_type}, function(dt){
            if(dt.err)
            {
